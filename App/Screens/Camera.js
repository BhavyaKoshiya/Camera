...
export default function Camera({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <RNCamera
                ref={(ref) => { camera = ref }}
                style={{ width: "100%", padding: 20, height: Dimensions.get('screen').height }}
            ...
            >
                ...
                <View style={{ flex: 1, justifyContent: 'flex-end',marginBottom:'15%' }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center', marginTop: 30, }}>
                        <TouchableOpacity
                            style={{ padding: 20, }}
                            onPress={() => { setMode(true), setFlash('auto') }}
                        >
                        ...
                        <TouchableOpacity
                            style={{ padding: 20 }}
                            onPress={() => { setMode(false), setFlash('off') }}
                        >
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center', }}>
                        ...
                        {/* isRecording ? nothing : Switch Camera */}
                        {isRecording ?
                            <View style={{ height: 50, width: 50, }} />
                            :
                            <TouchableOpacity
